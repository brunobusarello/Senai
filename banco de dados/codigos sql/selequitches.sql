##Comandos para criar o banco de dados e dados para inserir
...
select nm_empregado NOME, funcao FUNÇÃO, salario "SALÁRIO FIXO" from empregado where id_departamento = 10 and salario >= 1000;

select nm_empregado NOME, funcao FUNÇÃO, salario "SALÁRIO FIXO" from empregado where nm_empregado like '____S';

select nm_empregado NOME, funcao FUNÇÃO, salario, comissao "SALÁRIO FIXO" from empregado where comissao is null;

select nm_empregado NOME, funcao FUNÇÃO, salario "SALÁRIO FIXO", d.nm_departamento 
from empregado e join departamento d on d.id_departamento = e.id_departamento
where e.id_departamento in (10,30);

select nm_empregado NOME, funcao FUNÇÃO, salario from empregado where salario between 800 and 1200;

select nm_empregado NOME, funcao FUNÇÃO, salario from empregado order by nm_empregado asc;